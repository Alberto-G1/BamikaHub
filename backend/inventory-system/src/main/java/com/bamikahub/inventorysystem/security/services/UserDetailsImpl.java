...
public class UserDetailsImpl implements UserDetails {
    ...
    public UserDetailsImpl(Long id, String name, String email, String password, String status, Collection<? extends GrantedAuthority> authorities) {
        this.id = id;
        this.name = name;
        this.email = email;
    ...
    public static UserDetailsImpl build(User user) {
        ...
        // Also add the role itself as an authority, prefixed with ROLE_
