package com.bamikahub.inventorysystem.security;

import com.bamikahub.inventorysystem.security.jwt.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .cors(cors -> cors.configurationSource(corsConfigurationSource())) // <-- ADD THIS EXPLICIT CORS CONFIG
    ...
    // v-- BEAN FOR CORS CONFIGURATION --v
    @Bean
